...
<template>
  ...
  <ShadSidebarInset
    ...
    :class="{ '!ml-0': useSidebar().state.value === 'expanded' }"
  >
    <header
      class="flex h-16 shrink-0 items-center justify-between gap-2 transition-all sticky z-10 top-0 ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12" :class="[
