  ...
  <div class="flex flex-col gap-6">
    <ShadCard class="overflow-hidden p-0">
      <ShadCardContent class="grid p-0 lg:grid-cols-2 lg:min-h-[75vh] xl:min-h-[70vh]">
        <div class="relative flex flex-col justify-center overflow-hidden p-6 md:p-8">
          <!-- Step 1: Email & Social -->
          <Transition
            enter-active-class="transition-all duration-300 ease-out"
            enter-from-class="-translate-x-full opacity-0"
            enter-to-class="translate-x-0 opacity-100"
            leave-active-class="transition-all duration-300 ease-in absolute inset-6 md:inset-8"
